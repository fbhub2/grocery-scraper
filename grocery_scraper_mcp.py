...
async def list_tools() -> list[types.Tool]:
    return [
        types.Tool(
            ...
            description="Søk etter produkter hos Oda, Meny og OBS (lokal). Returnerer navn, pris, butikk og bilde-URL.",
            inputSchema={
                "type": "object",
                "properties": {
        ...
        types.Tool(
            name="compare_prices",
            description="Sammenlign pris på et produkt mellom Oda, Meny og OBS.",
            inputSchema={
                "type": "object",
        ...
        types.Tool(
            ...
            description="Legg til flere produkter på én gang.",
            inputSchema={
                "type": "object",
                "properties": {
                    "list_name": {"type": "string", "default": "default"},
...
async def call_tool(name: str, arguments: dict):
    ...
    if name == "add_multiple_to_list":
        ...
        return [types.TextContent(type="text", text=f"Lagt til {len(arguments['items'])} produkter")]
    ...
    if name == "import_obs_catalog":
        ...
        return [types.TextContent(
            type="text",
            text=f"Importerte {len(products)} OBS-produkter. Gyldige til {arguments['valid_to']}",
        )]
